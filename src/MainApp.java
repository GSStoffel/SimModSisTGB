...
//
//        Process chegada = de.createProcess(new Chegada(1, "Chegada", de.exponential(3)));
//
//        Process comendoB = de.createProcess(new Comendo(1,"Comendo", de.normal(8.0, 2.0)));
//        Process comendoM2 = de.createProcess(new Comendo(2,"ComendoM2", de.normal(8.0, 2.0)));
//        Process comendoM4 = de.createProcess(new Comendo(3,"ComendoM4", de.normal(8.0, 2.0)));
